...
\begin{tikzpicture}[scale=1]
	\tkzTabInit[lgt=3,espcl=1.7]{$x$ / 1 , Signe de $A$ / 1}{$-\infty$, $-4$, $+\infty$}
...
\begin{tikzpicture}[scale=1]
	\tkzTabInit[lgt=3,espcl=1.7]{$x$ / 1 ,Signe de $A$ / 1}{$-\infty$, ${\red -4}$, $+\infty$}
		\draw[fill=red!50, opacity=0.3] (T11) rectangle (N20);
		\draw[fill=blue!50, opacity=0.3] (T12) rectangle (N21);
	\tkzTabLine{, -, {\blue 0}, +, }
\end{tikzpicture}
\vspace{.2cm}

\begin{tikzpicture}[scale=1]
		\tkzTabInit[lgt=3]{$x$ / 1 , $2x+6$ / 1, $-x+2$ /1, $(2x+6)(-x+2)$ /1}{$-\infty$, ${\red -3}$,${\red 2}$, $+\infty$}
		\draw[fill=red!50, opacity=0.3] (N21) rectangle (N30);
		\draw[fill=blue!50, opacity=0.3] (N24) rectangle (N33);
		\tkzTabLine{, -, z, +,, +, }
		\tkzTabLine{, +,,  +,z, -, }
...
\begin{tikzpicture}[scale=1]
		...
		\tkzTabInit[lgt=3]{$x$ / 1 , $2x+6$ / 1, $-x+2$ /1, $\dfrac{2x+6}{-x+2}$ /1.5}{$-\infty$, ${\red -3}$,$2$, $+\infty$}
		\draw[fill=red!50, opacity=0.3] (T11) rectangle (N20);
