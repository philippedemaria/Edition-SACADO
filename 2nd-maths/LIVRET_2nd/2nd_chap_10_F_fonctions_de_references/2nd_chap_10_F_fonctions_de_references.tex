...
\begin{tikzpicture}
   \tkzTabInit{$x$ / 1 , Signe de $-3x-6$ / 1}{$-\infty$, $-2$, $+\infty$}
   \tkzTabLine{, +, z, -, }
%   \tkzTabLine{, +, z, -, }
\end{tikzpicture}
\vspace{.2cm}
...
\begin{tikzpicture}
   \tkzTabInit[lgt=3]{$x$ / 1 , $x$ / 1, $1-x$ / 1, $1+x$ / 1, $x(1-x)(1+x)$ / 1}{$-\infty$, $-1$, $0$, $1$, $+\infty$}
   \tkzTabLine{, -, , -, z, +, , +}
   \tkzTabLine{, +, , +, , +, z, -}
   \tkzTabLine{, -, z, +, , +, , +}
   \tkzTabLine{, +, z, -, z, +, z, -}
   \fill [fill=red, opacity=.2] (T11) rectangle (N20);
   \fill [fill=red, opacity=.2] (N31) rectangle (N40);
   \fill [fill=blue, opacity=.2] (T15) rectangle (N24);
   \fill [fill=blue, opacity=.2] (N35) rectangle (N44);
\end{tikzpicture}

\vspace{.2cm}

\begin{tikzpicture}
   \tkzTabInit[]{$x$ / 1 , $x$ / 1, $x-1$ / 1, $x(x-1)$ / 1}{$-\infty$, $\textcolor{red}{0}$, $\textcolor{red}{1}$, $+\infty$}
   \tkzTabLine{, -, z, +, , +}
   \tkzTabLine{, -, , -, z, +}
   \tkzTabLine{, +, z, -, z, +}
   \fill [fill=red, opacity=.2] (T11) rectangle (N20);
   \fill [fill=red, opacity=.2] (N31) rectangle (T20);
   \fill [fill=blue, opacity=.2] (T14) rectangle (N23);
   \fill [fill=blue, opacity=.2] (N34) rectangle (T23);
\end{tikzpicture}
