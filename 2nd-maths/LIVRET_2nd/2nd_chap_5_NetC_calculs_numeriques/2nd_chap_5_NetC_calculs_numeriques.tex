...
\draw [line width=1.pt,color=qqqqff] (-4.,0.)-- (-2.,0.);
...
\begin{DefT}{Racine carrée du nombre}\index{Puissance d'un nombre}
...
$A=\frac{1}{1+\sqrt5} +\frac{1}{1-\sqrt5} = $ \point{1}
...
$A=\frac{\sqrt{20}}{4}=$ \point{2} 

$B = \frac{2-\sqrt{8}}{4}=$\point{2} 
...
$A=-\frac{20}{16} \times \frac{4}{17}=$\point{1}

$B=\frac{35}{24} \times \frac{18}{15}=$\point{1}
\end{ExoCuN}
\end{minipage}
\begin{minipage}{0.5\linewidth}
\begin{ExoCuN}{Calculer.}{43}{1}{0}{0}{0}{0}
...
$C=-\frac{-4}{10} \div \frac{20}{16}=$\point{1}

$D=\frac{12}{11} \div \frac{10}{9}=$\point{1}
...
$A=\frac{-6 \times ( -5) \times (-12)}{9 \times ( -4) \times 3 \times (-10)}=$\point{3}
...
$A=\frac{4}{5} - \frac{2}{5} \times \frac{3}{8}=$\point{2} 

$B = \frac{12}{5} \times \left(\frac{3}{4} + \frac{7}{4} \right)=$\point{2} 

$C = \frac{-\frac{1}{4} -\frac{2}{3}}{\frac{3}{4}+\frac{2}{3}}=$\point{2} 
\end{ExoCu}
...
\vrule
\begin{minipage}{0.48\linewidth}
$c= \frac{1}{(-7) \times (-7)\times (-7) \times (-7)\times (-7) \times (-7)}  =$  \point{1}
...
Effectuer le calcul suivant : $A= \frac{(-4)^2\times 3^2\times 4^3 }{5^2\times 3^2\times 4^3} $  \point{4}
...
$A=\frac{1}{1+\sqrt5} +\frac{1}{1-\sqrt5} = $ \point{2}
...
\draw [line width=1.pt] (0.,-3.)-- (4.,-3.);
\draw [line width=1.pt] (4.,-3.)-- (5.,-2.);
\draw [line width=1.pt,dash pattern=on 3pt off 3pt] (5.,-2.)-- (1.,-2.);
\draw [line width=1.pt,dash pattern=on 3pt off 3pt] (1.,-2.)-- (0.,-3.);
\draw [line width=1.pt] (0.,1.)-- (4.,1.);
\draw [line width=1.pt] (4.,1.)-- (5.,2.);
\draw [line width=1.pt] (5.,2.)-- (1.,2.);
\draw [line width=1.pt] (1.,2.)-- (0.,1.);
\draw [line width=1.pt] (0.,1.)-- (0.,-3.);
\draw [line width=1.pt,dash pattern=on 3pt off 3pt] (1.,-2.)-- (1.,2.);
\draw [line width=1.pt] (4.,1.)-- (4.,-3.);
\draw [line width=1.pt] (5.,-2.)-- (5.,2.);
\draw [line width=1.pt,dash pattern=on 3pt off 3pt] (1.,2.)-- (2.,-3.);
\draw [line width=1.pt] (0.,-3.)-- (2.,-3.);
\draw [line width=1.pt] (1.,-2.88) -- (1.,-3.12);
\draw [line width=1.pt] (2.,-3.)-- (4.,-3.);
\draw [line width=1.pt] (3.,-2.88) -- (3.,-3.12);
\begin{scriptsize}
