...
import qrcode
def qr(data,taille):
     fic=r"qrcodes/qr"+data[0]+data[2:]+'.png'
     urllongue=r"https://sacado.xyz/"+data
     qr = qrcode.QRCode(version=1,
error_correction=qrcode.constants.ERROR_CORRECT_L,box_size=1.5, border=0)
     qr.add_data(urllongue)
     qr.make(fit=True)
...
\includegraphics{"""+fic+r"}\\{\scriptsize\tt "+data+r"}\end{center}}"
\end{pycode}

% compilation complete

\newcommand{\qr}[1]{\py{qr("#1",1)}} % compilation complete
%utiliser :
