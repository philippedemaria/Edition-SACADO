...
\pagecolor{sacado_orange!6}
\headerGeneral{Algorithme et programmation}{sacado_gray}{p/1234}
} }{ \newpage}
...
\newenvironment{DefTQ}[2]{% titre,qrcode
...
\ifthenelse{\equal{#2}{}}{}{\hspace{-0.7cm}\begin{minipage}{1.4cm}\qr{#2}\end{minipage}}\begin{minipage}{8cm}}{%
\end{minipage}\end{tcolorbox}\par}

\newenvironment{DefLTQ}[2]{% titre,qrcode
\medskip \begin{tcolorbox}[widget,colback=sacado_violet!15,colframe=sacado_violet!75!black,
title= \stepcounter{cpt} Définition \thecpt
\ifthenelse{\equal{#1}{}}{.}{ : #1.}]
\ifthenelse{\equal{#2}{}}{}{\hspace{-0.7cm}\begin{minipage}{1.4cm}\qr{#2}\end{minipage}}\begin{minipage}{18cm}}{%
\end{minipage}\end{tcolorbox}\par}
...
%%%%%%%%%%%%% Théorèmes
\newenvironment{ThTQ}[2]{%
\medskip \begin{tcolorbox}[widget,colback=white!100,colframe=sacado_red!75!black,
...
%%%%%%%%%%%%% Méthode
\newenvironment{Mt}{%
\medskip \begin{tcolorbox}[widget,colback=white!15,colframe=sacado_green!75!black,
...
\end{minipage}
\hfill
\begin{minipage}[t]{17cm}%\colorbox{sacado_violet}
\hspace{-1cm}\qr{#2}
